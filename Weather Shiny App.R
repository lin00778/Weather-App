...
# input data
weather <- read.csv("weather_new.csv") # generated in the web: https://www.visualcrossing.com/weather/weather-data-services
city <- read.csv("CityGeo.csv")        # manually collected from web
info <- read.csv("City_Info.csv")      # manually collected from web
